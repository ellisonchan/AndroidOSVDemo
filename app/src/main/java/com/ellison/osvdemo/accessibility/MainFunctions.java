...
//            e.printStackTrace();
    ...
    private void printComposeNode(ArrayList<AccessibilityNodeInfo> root) {
        Log.i(TAG, "printComposeNode() invoked:" + invoked);
        ...
        for (AccessibilityNodeInfo node : root) {
            if (node.getPackageName().equals("com.google.accompanist.sample")
                    ...
                    && node.isScrollable() && !invoked) {
                Log.i(TAG, "printComposeNode() got accompanist package & track");
                Log.i(TAG, "printComposeNode() with node:" + node);

                Log.i(TAG, "printComposeNode() ACTION_SCROLL_FORWARD node:");
    ...
    public void onAccessibilityEvent(AccessibilityEvent event) {
        // Log.i(TAG, "onAccessibilityEvent() event: " + event + " source: " + event.getSource());
        ...
        try {
            switch (event.getEventType()) {
                case AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED:
                    ...
                    Log.i(TAG, "TYPE_WINDOW_STATE_CHANGED() with root node:" + root);
...
//                    }
                ...
                case AccessibilityEvent.TYPE_WINDOW_CONTENT_CHANGED:
                    root = service.getRootInActiveWindow();
                    Log.i(TAG, "TYPE_WINDOW_CONTENT_CHANGED() with root node:" + root);

//                    roots.add(root);
//                    findAllNode(roots, nodeList);
//
//                    Log.i(TAG, "TYPE_WINDOW_CONTENT_CHANGED() with nodeList:" + nodeList);
//
//                    roots.clear();
//                    nodeList.clear();
